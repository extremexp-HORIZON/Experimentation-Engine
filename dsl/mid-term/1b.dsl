workflow IDEKO {
  ...
  configure task ReadData {
    implementation "tasks/IDEKO/Binary_v0/read_data.py";
    dependency "tasks/IDEKO/Binary_v0/src/**";
  }

  configure task AddPadding {
      implementation "tasks/IDEKO/Binary_v0/add_padding.py";
      dependency "tasks/IDEKO/Binary_v0/src/**";
    }

  configure task SplitData {
      implementation "tasks/IDEKO/Binary_v0/split_data.py";
      dependency "tasks/IDEKO/Binary_v0/src/**";
  }
...
workflow AW1 from IDEKO {
  configure task TrainModel {
      implementation "tasks/IDEKO/Binary_v0/train_nn.py";
  }
}
